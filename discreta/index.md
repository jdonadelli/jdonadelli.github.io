...
|   10   | Funções geradoras | Funções geradoras e resolução de recorrências. | - leitura de [texto](SEMANA10.pdf)<br />- resolução de exercícios<br />- discussão no fórum da semana |
|   11   | Funções geradoras              | Funções geradoras e resolução de recorrências.               | - leitura de texto<br />- resolução de exercícios<br />- discussão no fórum da semana |
